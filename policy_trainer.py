import copy
import franka_controller.se3_tools
...
class InteractionDataset(Dataset):
    ...
    def augment_image(self, im):
        ...
        if ran_num < .25:
            ...
            # print("Random noise")
            # plt.imshow(torch.Tensor(im).permute(1, 2, 0))
            # plt.show()
        elif .25 <= ran_num < .50:
...
if __name__ == '__main__':
    ...
    # THIS IS TO TRAIN THE ORIENTATION NETWORK
    ...
    # THIS IS TO TRAIN THE DISPLACEMENT NETWORK
    trainer = PolicyTrainer(task_name="test",
                            action_horizon=5,
                            predict_only_displacement=True,
                            vision_only=False,
